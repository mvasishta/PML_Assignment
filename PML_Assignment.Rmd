...
trainData <- read.csv("/Users/mvasishta/Documents/R-workspace/PML/data/pml-training.csv")
testData <- read.csv("/Users/mvasishta/Documents/R-workspace/PML/data/pml-testing.csv")
```
